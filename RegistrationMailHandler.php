...
<head>
    ...
    <link rel="stylesheet" href="/LICProject/style/base.css">
    <link rel="stylesheet" href="/LICProject/style/desktop.css">
    <link rel="stylesheet" href="/LICProject/style/mobile.css">
...
<body style="height:100vh;display:flex;align-items:center;flex-direction:column;width:100vw;margin:0;">
    <div class="registration-complete-wrapper">
        ...
        <div class="actions">
            ...
            <a href="./index.php"><button>Continue to homepage</button></a>
        </div>
