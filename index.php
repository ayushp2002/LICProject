        ...
        <div class="stepgroup">
            <div class="block">
                <div class="head">
                    ...
                    <img src="/LICProject/images/expand-arrow-icon.png" class="expandicon" id="expicon1" onclick="toggleRegprocessContent1()">
                </div>
            ...
            <div class="wrapper" id="parr1">
                <img src="/LICProject/images/arrow-icon.png" class="processarrow">
            </div>
            <div class="block">
                <div class="head">
                    <h2>Step 2 : Training</h2>
                    <img src="/LICProject/images/expand-arrow-icon.png" class="expandicon" id="expicon2" onclick="toggleRegprocessContent2()">
                </div>
            ...
            <div class="block">
                <div class="head">
                    ...
                    <img src="/LICProject/images/expand-arrow-icon.png" class="expandicon" id="expicon3" onclick="toggleRegprocessContent3()">
                </div>
            ...
            <div class="block">
                <div class="head">
                    ...
                    <img src="/LICProject/images/expand-arrow-icon.png" class="expandicon" id="expicon4" onclick="toggleRegprocessContent4()">
                </div>
